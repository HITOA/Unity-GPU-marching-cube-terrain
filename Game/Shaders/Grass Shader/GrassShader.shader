Shader "Game/GrassShader"
{
    Properties
    {
        ...
        _GrassSizeDistanceMultiplier("Grass Distance Multiplier", Float) = 0.01
        _GrassMinHeight("Grass Min Height", Float) = 0
        _GrassScaleRandomness("Grass Scale Randomness", Float) = 0
    }
    SubShader
    {
